...
parser.add_argument('-w', '--word', type=str, help='Receive a word to search it in the text file')
...
counted_words = words_counting(text)
#print(counted_words)
if str(words_to_count) in counted_words:
    print(counted_words[str(words_to_count)])
